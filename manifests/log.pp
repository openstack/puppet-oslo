...
define oslo::log(
  ...
  $log_options = {
    ...
    'DEFAULT/log-config-append'             => { value => $log_config_append },
    'DEFAULT/log-date-format'               => { value => $log_date_format },
    'DEFAULT/log-file'                      => { value => $log_file },
    'DEFAULT/log-dir'                       => { value => $log_dir },
    'DEFAULT/watch-log-file'                => { value => $watch_log_file },
    'DEFAULT/use-syslog'                    => { value => $use_syslog },
    'DEFAULT/use-journal'                   => { value => $use_journal },
    'DEFAULT/use-json'                      => { value => $use_json },
    'DEFAULT/syslog-log-facility'           => { value => $syslog_log_facility },
